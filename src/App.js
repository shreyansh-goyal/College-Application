  ...
  render() {
    return (
      ...
      <div className="main">
        ...
        <Route exact path="/manualEntry/Upload Attendence" component={ManualData}/>
        <Route  path="/excelEntry/:parameters" component={ExcelData}/>
        <Route exact path="/manualEntry/Add Students" component={AddStudent}/>
        <Route exact path="/manualEntry/Update Students" component={UpdateStudents}/>
        <Route exact path="/manualEntry/DeleteStudents" component={DeleteStudents}/>
        <Route exact path="/manualEntry/Add Teachers" component={AddTeacher}/>
        <Route exact path="/manualEntry/Update Teachers" component={UpdateTeachers}/>
        <Route exact path="/manualEntry/Delete Teacher" component={DeleteTeacher}/>
        <Route exact path="/manualEntry/Add Subject" component={AddSubject}/>
        <Route exact path="/manualEntry/Delete Subject" component={deleteSubject}/>
