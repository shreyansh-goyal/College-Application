...
class DeleteStudents extends Component{
    deleteStudent=()=>{
        axios.get("https://bpitconnect.herokuapp.com/students?enrollmentNo="+this.refs.studentId.value).then(data=>{
            console.log(data.data);
            axios.delete("https://bpitconnect.herokuapp.com/students/"+data.data[0].id).then(data=>{
        ...
        return(
            <div>
                <div class="form-group input-block">
                    ...
                    <input type="text" ref="studentId" class="form-control" placeholder="Enter StudentId"/>
                </div>
