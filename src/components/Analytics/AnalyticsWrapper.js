...
class analyticsWrapper extends Component {
  ...
  render() {
    return (
      <div style={{height:"620px",overflowY:"scroll",width:"100%",overflowX:"hidden"}}>
...
<span className="analyticsLogo">ANALYTICS</span>
<Button  variant="contained" color="secondary" className="sms" style={{fontWeight:"800",fontSize:"11px"}}>SMS</Button>
...
<div style={{margin:"0 auto"}}>
  ...
  <Modal
      ...
      >
        ...
        <Fade className="modal" in={this.state.open}>
...
<TableHead>
<TableRow>
<TableCell style={{fontSize:"20px"}}>Enrollment No</TableCell>
<TableCell style={{fontSize:"20px"}} align="right">Semester</TableCell>
<TableCell style={{fontSize:"20px"}} align="right">Section</TableCell>
<TableCell style={{fontSize:"20px"}} align="right">Group</TableCell>
<TableCell style={{fontSize:"20px"}} align="right">Present</TableCell>
<TableCell style={{fontSize:"20px"}} align="right">Absent</TableCell>
<TableCell style={{fontSize:"20px"}} align="right">Select</TableCell>
</TableRow>
</TableHead>
{ <TableBody>
{
