    ...
    render(){
        return(
            <div>
                ...
                <input type="file" title="Browse the files" placeholder="somefile" onChange={this.fetchdata} />
                </div>
            {this.state.attendenceArray.length>0&&<div><table className="table table-striped table-dark">
                <thead>
                    <tr>
